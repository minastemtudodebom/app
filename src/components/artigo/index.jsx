  ...
  return (
    <div>
      <div className="flex h-96 flex-col justify-center bg-queijo bg-cover bg-no-repeat md:h-[500px]">
        ...
        <button className="relative mx-5 mt-10 flex w-60 rounded-2xl bg-vermelho py-2 pl-4 font-alt font-bold text-beje drop-shadow-drop1 transition-all duration-300 ease-in-out hover:bg-red-500 md:mx-20">
